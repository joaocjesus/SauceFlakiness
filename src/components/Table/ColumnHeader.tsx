...
export const ColumnHeader = ({
    ...
    const defaultSort = columnSort.column === header ? columnSort.order : TableOrder.ASC;
    ...
    const getNextOrder = () => sort === TableOrder.ASC ? TableOrder.DESC : TableOrder.ASC;
